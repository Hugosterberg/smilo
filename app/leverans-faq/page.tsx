...
const deliveryFaqs = [
  ...
  { icon: CreditCard, question: "Vad kostar frakten?", answer: "Vi erbjuder fri frakt på alla beställningar inom Sverige! Inga dolda avgifter – priset du ser är priset du betalar." },
      ...
      <section className="py-8 border-y border-border bg-white/50">
        <div className="smilo-container">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              { icon: Truck, title: "Fri frakt", sub: "På alla beställningar", bg: "bg-smilo-olive/10", color: "text-smilo-olive" },
