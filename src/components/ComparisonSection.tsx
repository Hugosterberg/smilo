          ...
          <div className="bg-white rounded-3xl shadow-card overflow-hidden">
            ...
            <div className="divide-y divide-border">
              {comparisonFeatures.map((item, index) => (
                <motion.div
                  key={item.feature}
                  className="grid grid-cols-4 gap-2 sm:gap-4 p-3 sm:p-4 px-4 sm:px-6 items-center hover:bg-smajl-cream/30 transition-colors"
            ...
            <div className="p-4 sm:p-6 bg-smajl-cream/50 text-center">
              <p className="text-xs sm:text-sm text-smajl-brown-light italic">
                ✨ Smajl ger dig retrokänslan utan engångskamerans begränsningar och polaroidens höga kostnader
              </p>
            </div>
          </div>
        </motion.div>
