  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-base font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-heading uppercase tracking-[0.12em] border border-transparent",
  {
    variants: {
      variant: {
        ...
        hero: "bg-smilo-digital text-smilo-cream-light hover:bg-smilo-digital-dark shadow-cta hover:shadow-hover border-smilo-digital-dark/50 active:scale-[0.98] text-sm sm:text-base md:text-lg px-6 sm:px-8 py-3.5 sm:py-4 tracking-[0.14em] sm:tracking-[0.18em] whitespace-normal sm:whitespace-nowrap text-center",
        gold: "bg-smilo-digital text-smilo-cream-light hover:bg-smilo-digital-dark shadow-cta border-smilo-digital-dark/40",
